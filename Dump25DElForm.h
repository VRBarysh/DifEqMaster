...
__published:	// IDE-managed Components
        ...
        void __fastcall Button_ZSliceClick(TObject *Sender);
...
public:		// User declarations
        ...
        __fastcall TDump25DEl(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TDump25DEl *Dump25DEl;
//---------------------------------------------------------------------------
#endif
